...
local lwaftr_conf_spec = {
   parse={
      ...
      ipv4_fragment_cache_max=Parser.parse_non_negative_number,
      ipv6_fragment_cache_max=Parser.parse_non_negative_number,
   ...
   defaults={
      ...
      ipv4_fragment_cache_max=default(10000),  -- ~160MiB of 16KiB packets
      ipv6_fragment_cache_max=default(10000),
...
function selftest()
   ...
   test([[
            ...
            ipv4_fragment_cache_max = 1004
            ipv6_fragment_cache_max = 1006
            ipv4_mtu = 1460
            ipv6_mtu = 1500
